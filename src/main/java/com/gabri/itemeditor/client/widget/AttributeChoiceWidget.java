...
public class AttributeChoiceWidget extends BabelWidget {
    private final Component title;
    private final Component subtitle;
    private final Runnable onSelect;
    private boolean selected;

    public AttributeChoiceWidget(Component title, Component subtitle, Runnable onSelect) {
    ...
    public AttributeChoiceWidget selected(boolean selected) {
