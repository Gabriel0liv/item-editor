...
public class LootTableChoiceWidget extends BabelWidget {
    private final Component title;
    private final Component subtitle;
    private final Runnable onSelect;
    private boolean selected;

    public LootTableChoiceWidget(Component title, Component subtitle, Runnable onSelect) {
    ...
    public LootTableChoiceWidget selected(boolean selected) {
